...
Example of displaying feed from HDMI port as Picture-in-Picture via video inputs API.
...
* [Video Inputs API](https://developers.signageos.io/sdk/content/js-video-inputs-internal-ports)
